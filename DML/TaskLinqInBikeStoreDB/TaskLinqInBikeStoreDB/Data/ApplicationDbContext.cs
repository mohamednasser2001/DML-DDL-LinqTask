...
namespace TaskLinqInBikeStoreDB.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27F6E27DCA");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4F0D83C98");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85621DE73B");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962299A51F3C7");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4C00DBF41");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF50AE91A0A");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CAE891290");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D333CA1DA5");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C3FF0837D");
